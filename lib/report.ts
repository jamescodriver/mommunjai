  ...
  const plan90: PlanPhase[] = isMale
    ? [
        { phase: "เดือนที่ 1", title: "ปรับพื้นฐานฝ่ายชาย", items: [
            ...
            "ถ้าต้องการเสริม: Motila1 / M-Z All (ปรึกษาเภสัชกรถ้ามีโรคประจำตัว)",
          ] },
        { phase: "เดือนที่ 2", title: "เร่งบำรุงสเปิร์ม", items: ["ออกกำลังกายสม่ำเสมอ ไม่หักโหม", "ลดน้ำตาล/อาหารแปรรูป", "ถ้าต้องการเสริมโปรตีน: Ferta เวย์โปรตีน"] },
