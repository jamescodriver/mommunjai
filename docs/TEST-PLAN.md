...
| TC-VI-04 | prep | ต้องได้ **≥ 18 รายการ** ครบตาม leaflet (regression: เคยรู้จักแค่ 7 ตัวและตัดเหลือ 3) · แกนหลัก = OvaAll/Ferty/Colla Telo/Ferti 9 Oil |
| TC-VI-05 | **pregnant** | **ต้องไม่มี** A.O.S · น้ำมะกรูด Shot · Pure Green · Varginaree · ดอกคำฝอย · น้ำมันละหุ่ง (Safety Matrix §4) |
| TC-VI-06 | **lactating** | ต้องไม่มี Varginaree |
| TC-VI-07 | artPlan ≠ none | ต้องมีคำเตือน "ปรึกษาแพทย์" + รายการที่ต้องหยุด "หลังใส่ตัวอ่อน" |
| TC-VI-08 | ทุกเคส | ทุกรายการมี `howto` · น้ำมันละหุ่งต้องระบุ "ห้ามรับประทาน" · ราคาที่ยังไม่ยืนยันแสดง "สอบถามราคา" ไม่เดาตัวเลข |
